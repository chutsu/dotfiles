...
Config.instname = "Imperial College London"
Config.profilename = "eduroam"
Config.url = " \
    ""http://www.imperial.ac.uk/admin-services/ict/contact-ict-service-desk/"
Config.email = "service.desk@imperial.ac.uk"
Config.title = "eduroam CAT"
Config.server_match = "wireless.ic.ac.uk"
...
Config.user_realm = "ic.ac.uk"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:wireless.ic.ac.uk']
Config.use_other_tls_id = False
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = """All members of college are eligible to use the JRS / eduroam service, no additional registration is required.

However, the Imperial security policy requires to you obey the relevant JANET policies when using eduroam.

For more information, see section 2.8 of the Conditions of Use of IT Facilities, and the JANET eduroam policy."""
